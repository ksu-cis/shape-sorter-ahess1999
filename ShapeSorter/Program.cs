...
namespace ShapeSorter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("TrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevinTrevin");
            ...
            Console.WriteLine("Circles with area greater than 70");
